 ...
 * @LastEditTime: 2021-08-31 19:13:56
  ...
  methods: {
    ...
    async getzn() {
      const { data: res } = await this.$axios.get(
        "http://120.53.31.103:84/api/integral/shop/index?type=1&"
      );
      //   if (res.code == 200) {
      //     this.list = res;
      //   }
    ...
    // getzn(){
    //     this.$axios.get("http://120.53.31.103:84/api/integral/shop/index?type=1&").then(res=>{
    //         console.log(res);
    //     })
    // }
  },
